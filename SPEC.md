...
```json
{
  ...
  "inputs": {
    "business_record": { "legal_name": "Transportes del Norte SA de CV", ... },
...
│  ├─────────────────────────────────────────────────────────────┤ │
│  │ ● Transportes del Norte   customer-onboard  WAITING  3d    │ │
│  │   → stuck at: Submit to compliance (waiting for callback)   │ │
│  │                                                             │ │
│  │ ● Logística Hernández     customer-onboard  WAITING  5d    │ │
│  │   → stuck at: Submit to compliance (waiting for callback)   │ │
│  │                                                             │ │
...
```
┌──────────────────────────────────────────────────────────────────┐
│  INSTANCE: Transportes del Norte — customer-onboarding v1.0      │
│  Started: 2026-04-15  •  State: WAITING  •  ID: inst_abc123      │
├──────────────────────────────────────────────────────────────────┤
│                                                                   │
│  INPUTS                                                           │
│  company_name: Transportes del Norte SA de CV                     │
│  contact_email: carlos@transportesdelnorte.com                    │
│  country: MX                                                      │
