  ...
  def run_customer_onboarding!
    ...
    instance = Opensop::InstanceExecutor.start(
      ...
      inputs: {
        ...
        "contact_email" => "ops@transportesdelnorte.mx",
        "country"       => "MX",
        "source_channel" => "referral",
        "deal_id"       => "CRM-9912"
      },
      metadata: { "demo" => true, "company_name" => "Transportes del Norte" }
    )
    ...
    business_record = {
      "legal_name"      => "Transportes del Norte S.A. de C.V.",
      "rfc"             => "TDN060402AA1",
      "fiscal_address"  => "Av. Industrial 2300, Monterrey, NL, MX",
      "industry"        => "logistics",
